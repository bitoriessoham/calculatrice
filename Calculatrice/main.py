...
btn_nega=tk.Button(root,text="-",command=lambda:ajout_calcul("-"), width=5,font=('Arial',14))
btn_nega.grid(row=3,column=5)

btn_milti=tk.Button(root,text="x",command=lambda:ajout_calcul("*"), width=5,font=('Arial',14))
btn_milti.grid(row=4,column=5)

btn_div=tk.Button(root,text="/",command=lambda:ajout_calcul("/"), width=5,font=('Arial',14))
btn_div.grid(row=5,column=5)

btn_egale=tk.Button(root,text="=",command=eval_calcul, width=5,font=('Arial',14))
btn_egale.grid(row=6,column=3,columnspan=2)

btn_effacer=tk.Button(root,text="eff",command=effacer_ecran, width=5,font=('Arial',14))
